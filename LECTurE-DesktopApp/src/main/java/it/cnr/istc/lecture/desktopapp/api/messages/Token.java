...
public class Token extends Message {
    ...
    @JsonbCreator
    public Token(@JsonbProperty("lessonId") long lesson_id, @JsonbProperty("id") int id, @JsonbProperty("cause") Integer cause, @JsonbProperty("time") long time, @JsonbProperty("refEvent") String refEvent, @JsonbProperty("question") Integer question) {
